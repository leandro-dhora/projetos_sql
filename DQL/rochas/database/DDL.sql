DROP TABLE IF EXISTS rocha_utilizacao CASCADE;
DROP TABLE IF EXISTS empresa_rocha CASCADE;
DROP TABLE IF EXISTS rocha_local CASCADE;
DROP TABLE IF EXISTS classe CASCADE;
DROP TABLE IF EXISTS rocha CASCADE;
DROP TABLE IF EXISTS empresa CASCADE;
DROP TABLE IF EXISTS local_extracao CASCADE;
DROP TABLE IF EXISTS cor CASCADE;
DROP TABLE IF EXISTS tipo_servico CASCADE;
DROP TABLE IF EXISTS cidade CASCADE;
DROP TABLE IF EXISTS uf  CASCADE;
DROP TABLE IF EXISTS tipo_rocha  CASCADE;
DROP TABLE IF EXISTS utilizacao CASCADE;
DROP TABLE IF EXISTS tipo_rocha_cor CASCADE;
